...
$query = "SELECT trainer.*, trainer_details.*,trainer_details.created_at AS datemember
          FROM trainer
          JOIN trainer_details ON trainer.id = trainer_details.trainer_id
          JOIN users ON users.id = trainer_details.user_id
