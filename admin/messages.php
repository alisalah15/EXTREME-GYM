...
// Total records query
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM messages";

if (isset($_GET['search'])) {
    $searchTerm = $_GET['search'];
    $totalRecordsQuery .= " WHERE (name LIKE '%$searchTerm%' OR email LIKE '%$searchTerm%')";
}
            ...
            <div class="col-10 mx-auto">
                ...
                <form class="mb-4" method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Search by name, email" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
                        ...
                        if (isset($result) && mysqli_num_rows($result) > 0):
                            foreach ($result as $value):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="deletemessage.php?id=<?php echo $value['id']; ?> "
