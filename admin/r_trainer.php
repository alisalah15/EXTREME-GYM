...
$query = "SELECT * FROM trainer WHERE `status` = 2";
...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM trainer WHERE `status`=2";
...
<div class="row">
    <div class="col-10 mx-auto">
        ...
        <center>
            <a type="button" href="r_trainer.php" class="btn btn-info">View All TRAINERS</a>
        </center>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="accept.php" method="post">
                                                ...
                                                <label for="">Add G-Coins for <?php echo $value['name'] ?></label>
